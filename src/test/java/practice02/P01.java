...
public class P01 extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        alert.click();
        System.out.println(driver.switchTo().alert().getText());//Alert uzerindeki yaziyi konsolaya yazdik
        ...
        String printMessage = driver.findElement(By.xpath("//*[@id='demo1']")).getText();
        System.out.println("print = " + printMessage);
        //    aseertion these message

        Assert.assertEquals("Hello TechProEducation How are you today",printMessage);
    }
}