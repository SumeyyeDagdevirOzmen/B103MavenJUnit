...
public class P08_JSExecutor extends TestBase {
    ...
    public void test08() throws InterruptedException {
        ...
        //    -- Back to top bölümüne kadar scroll yapınız
        //WEB ELEMENTI CLASSNAME ILE LOCATE ETTIK
       ...
       // js.executeScript("arguments[0].click();",backToTop);
        //backToTop.click(); boyle de yazilabilir.

    }
}

/*
JS locate almanın en üst versiyonu. %90 ihtimalle gerek kalmayacaktır.

Olur ya bi gün bir locate ısrarla alınmaz her şeyi denersnz olmaz o zaman JS kullanırsınız.
 Kullanımı tamamen sizin konforonuza bağlı.
 */