...
public class C03_FluentWait extends TestBase {
    ...
    public void fluentWaitTest(){
        ...
        Wait<WebDriver> wait = new FluentWait<>(driver)
                ...
                .withMessage("IGNORE EXCEPTION")//opsiyonel olarak kullanilir, zorunlu degil
                .ignoring(NoSuchElementException.class);//Exception'i handle et ,kullanmak zorunlu degil.
